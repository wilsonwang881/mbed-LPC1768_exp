...
//            }
            ...
            if(incre_flag_C5==2){
                incre_flag_C5 = 0;
                current_fre+=fre_increment;
                if(current_fre>=99999){
                    current_fre = current_fre-99979;
                }
            }
        }
...
//            }
            ...
            if(incre_flag_C2==2){
                ...
                else if(fre_increment==10){
                    fre_increment = 100;
                }
                else if(fre_increment==100){
                    fre_increment = 1000;
                }
                else if(fre_increment==1000){
                    fre_increment = 10000;
                }
                else if(fre_increment==10000){
                    fre_increment = 1;
                }
            }
        }
